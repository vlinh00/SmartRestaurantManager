...
public class DlgThemKhachHang extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean flag = customerService.addCustomer(new Customer(0, txtHo.getText(), txtTen.getText(), null, 0, null));

        //boolean flag = customerService.addCustomer(txtHo.getText(), txtTen.getText(), cmbGioiTinh.getSelectedItem() + "");
        checkThemKhach = flag;
        if (flag) {
            this.dispose();
        }
