...
public class DlgDoiMatKhau extends javax.swing.JDialog {
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Mật khẩu cũ không đúng", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                return;
        }
        if(!txtMatKhauMoi.getText().equals(txtNhapLaiMatKhau.getText()) )
        {
            JOptionPane.showMessageDialog(null, "Mật khẩu mới không khớp", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                return;
        }
        
        boolean flag = userService.changePassword(Session.userId, txtNhapLaiMatKhau.getText());
        if (flag) {
            var userNewPass = userService.getUser(Session.userId);
            Session.setPara(userNewPass);
            btnHuy.doClick();
        }
