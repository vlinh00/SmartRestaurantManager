...
public class DlgQuanLyLoai extends javax.swing.JDialog {
    ...
    private void loadDataLenTblLoai() {
        ...
        if (lst != null) {
            for (Category type : lst) {
                ...
                vec.add(type.getCategoryId());
                vec.add(type.getName());
                dtmLoai.addRow(vec);
            }
        }
    }
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        var category = new Category(0, txtTenLoai.getText());
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        var category = new Category(Integer.parseInt(txtMaLoai.getText()), txtTenLoai.getText());
